                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Summary</h2>
												<p>View summary of catalogued assets</p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="row">
                            ...
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="col-xs-3 mar-bot-15 text-left">
                                        <label class="label bg-green">200% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo categoryCount(1) ?></h2>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo categoryCount(5) ?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="text-left col-xs-3 mar-bot-15">
                                        <label class="label bg-blue">200% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo categoryCount(3) ?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo categoryCount(7); ?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="white-box analytics-info-cs mg-b-30 res-mg-t-30">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right sp-cn-r"><span class="counter sales-sts-ctn"><?php echo surplusCount(); ?></span></li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs mg-b-30">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right"> <span class="counter sales-sts-ctn"><?php echo locationCount(); ?></span></li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs mg-b-30">
                            <h3 class="box-title">Expired Warranties</h3>
                            <ul class="list-inline two-part-sp">
                                <li>
                                    <div id="sparklinedash3"></div>
                                </li>
                                <li class="text-right"> <span class="counter sales-sts-ctn">13</span></li>
                            </ul>
                        </div>
                        <div class="white-box analytics-info-cs">
                            ...
                            <ul class="list-inline two-part-sp">
                                ...
                                <li class="text-right"> <span class="sales-sts-ctn">2</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
